...
const ENTRIES: SearchEntry[] = [
  ...
  { path: '/vender', label: 'Vender', keywords: ['vendas', 'caixa'], icon: <ClipboardIcon className="w-5 h-5" />, roles: ['SUPER_ADMIN', 'MANAGER', 'STAFF'] },
  ...
  { path: '/reservations', label: 'Reservas', keywords: ['reserva', 'mesas', 'agendamento'], icon: <CalendarIcon className="w-5 h-5" />, roles: ['SUPER_ADMIN', 'MANAGER', 'STAFF'] },
  { path: '/reservations/trends', label: 'Tendências de reservas', keywords: ['reserva', 'tendência', 'análise'], icon: <ChartBarIcon className="w-5 h-5" />, roles: ['SUPER_ADMIN', 'MANAGER', 'STAFF'] },
  { path: '/locations', label: 'Locais', keywords: ['local', 'endereço', 'loja'], icon: <MapPinIcon className="w-5 h-5" />, roles: ['SUPER_ADMIN', 'MANAGER'] },
  { path: '/menu/items', label: 'Cardápio', keywords: ['cardápio', 'menu', 'itens', 'produto', 'preço'], icon: <BookOpenIcon className="w-5 h-5" />, roles: ['SUPER_ADMIN', 'MANAGER'] },
  ...
  { path: '/settings/payment', label: 'Pagamentos online', keywords: ['pagamento', 'stripe', 'paypal', 'gateway', 'payment'], icon: <CreditCardIcon className="w-5 h-5" />, roles: ['SUPER_ADMIN'] },
  ...
  { path: '/settings/reservation', label: 'Configurações de reservas', keywords: ['reserva', 'agendamento', 'config'], icon: <CogIcon className="w-5 h-5" />, roles: ['SUPER_ADMIN', 'MANAGER'] },
